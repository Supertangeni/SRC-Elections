...
font-family: Agency FB;
 background-image: url("Background/admin2.jpg");
}
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">UNAM SRC Election</a>
    </div>
    <ul class="nav navbar-nav">
      <li class="active"><a href="AdminWork.php"><b>&nbsp&nbsp&nbsp&nbsp Home</b></a></li>
