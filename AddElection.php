...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
     ...
     $can5=$_POST['cann5'];
      ...
      $query="insert into SetEC values('$EID','$Etitle','$sdate','$edate','$can1','$can2','$can3','$can4','$can5')";
      ...
      $query3="insert into Vote(ElectionID,ElectionName,CandidateName,TotVote) values('$EID','$Etitle','$can3','$cvote')";
       ...
       $cvote=0;
      $query4="insert into Vote(ElectionID,ElectionName,CandidateName,TotVote) values('$EID','$Etitle','$can4','$cvote')";
       mysqli_query($connection,$query4);

       $cvote=0;
      $query5="insert into Vote(ElectionID,ElectionName,CandidateName,TotVote) values('$EID','$Etitle','$can5','$cvote')";
...
*/
 ...
 if (edate.value=="")
   ...
   if(document.getElementById("can4").value == "Select Candidate-4")
  {
     alert("Please select Candidate-4"); // prompt user
     document.getElementById("can4").focus(); //set focus back to control
     return false;
   }
     if(document.getElementById("can5").value == "Select Candidate-5")
    {
       alert("Please select Candidate-5"); // prompt user
       document.getElementById("can5").focus(); //set focus back to control
       return false;
 if(document.getElementById("can1").value ==document.getElementById("can2").value || document.getElementById("can1").value ==document.getElementById("can3").value||document.getElementById("can2").value ==document.getElementById("can3").value || document.getElementById("can1").value ==document.getElementById("can5").value
|| document.getElementById("can2").value ==document.getElementById("can5").value || document.getElementById("can3").value ==document.getElementById("can5").value || document.getElementById("can4").value ==document.getElementById("can5").value || document.getElementById("can1").value ==document.getElementById("can4").value
|| document.getElementById("can2").value ==document.getElementById("can4").value || document.getElementById("can3").value ==document.getElementById("can4").value)
   {
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">UNAM SRC Elections</a>
    </div>
...
<center>
 <form action="" method="POST" name="ElectionForm" onsubmit="return validform();">
    <input type="text" name="Electionid" placeholder="Enter Election ID"><br>
     ...
     &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp                                                                                        <input type="date" name="startDate"><span style="color:#E71D1D ">START DATE</span><br>
          &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp                                                                                                  <input type="date" name="EndDate"><span style="color:#E71D1D ">END DATE</span>
...
<div>
 ...
 <select  name="cann4" id="can4" onchange="fetch_select(this.value);">
  <option>Select Candidate-4</option>
  <?php
...
<div>
 ...
 <select  name="cann5" id="can5" onchange="fetch_select(this.value);">
  <option>Select Candidate-5</option>
  <?php
